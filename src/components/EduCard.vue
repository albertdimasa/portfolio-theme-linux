  ...
  <div :class="['win', { maximized }]">
    ...
    <div class="win-body flex flex-col gap-2 text-sm">
      <div v-if="!maximized" class="flex flex-col gap-2">
        ...
        <p class="font-mono text-[11px]" style="color: var(--orange)">{{ t('edu.school2_log') }}</p>
      </div>
      <div v-else class="flex flex-col gap-3">
        ...
        <div class="pb-3 border-b" style="border-color: var(--panel-border)">
          ...
          />
          <p
            class="font-mono text-[11px] mt-3 mb-2 tracking-wider select-none"
            style="color: var(--muted-dark)"
          >
            ── {{ t('edu.activities_label') }} ──
          </p>
          <div class="pl-3 flex flex-col gap-2.5">
            <div>
